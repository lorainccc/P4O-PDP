...
#| warning: false
PDP_AR_parsed |>
    group_by(completion_cohort, completion_status, access_minority) |>
    summarize(
        cohort_records = n(),
        match_expected = round(0.7 * sum(one_year_after_compl_match), 0)
    ) |>
...
#| warning: false
PDP_AR_parsed |>
    group_by(completion_cohort, completion_status, access_age) |>
    summarize(
        cohort_records = n(),
        match_expected = round(0.7 * sum(one_year_after_compl_match), 0)
    ) |>
...
#| warning: false
PDP_AR_parsed |>
    group_by(completion_cohort, completion_status, access_Pell) |>
    summarize(
        cohort_records = n(),
        match_expected = round(0.7 * sum(one_year_after_compl_match), 0)
    ) |>
...
#| warning: false
PDP_AR_parsed |>
    group_by(completion_cohort, completion_status, access_minority, Gender) |>
    summarize(
        cohort_records = n(),
        match_expected = round(0.7 * sum(one_year_after_compl_match), 0)
    ) |>
...
#| warning: false
PDP_AR_parsed |>
    group_by(completion_cohort, completion_status, Race) |>
    summarize(
        cohort_records = n(),
        match_expected = round(0.7 * sum(one_year_after_compl_match), 0)
    ) |>
...
#| warning: false
PDP_AR_parsed |>
    group_by(completion_cohort, completion_status, Race, Gender) |>
    summarize(
        cohort_records = n(),
        match_expected = round(0.7 * sum(one_year_after_compl_match), 0)
    ) |>
